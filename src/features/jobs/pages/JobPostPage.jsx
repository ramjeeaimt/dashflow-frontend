...
// jobs will be loaded from the backend
...
export default function JobPostPage() {
  ...
  async function fetchJobs() {
    try {
      ...
      // After API client unwrapping, res.data should be the array directly
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="px-6 py-6 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
            <div>
              ...
              <h1 className="text-2xl font-semibold text-gray-800 tracking-tight">Job Postings</h1>
          ...
          {/* Stats Row - Clean cards without shadows */}
          ...
          {/* Job Cards Grid - Clean borders, no shadows/gradients */}
          {filtered.length === 0 ? (
              ...
              {filtered.map((job, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-base font-medium text-gray-800 mb-0.5">{job.title}</h3>
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs font-medium text-gray-700">{job.applicants}</span>
                    ...
                    <div className="flex items-center gap-2 pt-3 border-t border-gray-100">
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 py-1.5 text-xs font-medium rounded-md bg-gray-50 hover:bg-gray-100 text-gray-600 transition-colors"
                      >
                        <Icon name={job.isActive ? 'PauseCircle' : 'PlayCircle'} size="12" />
                        {job.isActive ? 'Pause' : 'Activate'}
                      </button>
                      <button
                        onClick={() => window.location.href = '/jobs/applications'}
                        className="flex-1 flex items-center justify-center gap-1.5 py-1.5 text-xs font-medium rounded-md bg-blue-50 hover:bg-blue-100 text-blue-600 transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="p-1.5 text-xs font-medium rounded-md bg-gray-50 hover:bg-red-50 text-gray-500 hover:text-red-600 transition-colors"
                      >
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
          <div className="bg-white border border-gray-200 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-5 border-b border-gray-100">
              ...
              <button onClick={() => { setIsOpen(false); setForm(EMPTY_FORM); }} className="p-1.5 hover:bg-gray-100 rounded-md transition-colors">
      ...
      {deleteId && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
          <div className="bg-white border border-gray-200 rounded-xl w-full max-w-sm p-5 text-center">
            ...
            <p className="text-sm text-gray-500 mb-5">This job and all its data will be permanently deleted.</p>
            <div className="flex gap-3">
              ...
              <button onClick={doDelete} className="flex-1 py-2 bg-red-500 text-white rounded-lg text-sm font-medium hover:bg-red-600 transition-colors">Delete</button>
            </div>
          </div>
        </div>
      )}
