                ...
                <div className="max-w-6xl mx-auto px-6 py-10">
                    ...
                    <div className="bg-white rounded-3xl border border-slate-200/60 shadow-sm overflow-hidden mt-8">
                        <div className="px-8 py-5 border-b border-slate-50 bg-slate-50/20 flex items-center gap-4">
                            <h3 className="text-sm font-bold text-slate-800 mr-auto">Employee Records</h3>
                            <button onClick={() => setProfileTab('attendance')} className={`px-4 py-2 rounded-xl text-xs font-bold transition-all ${profileTab === 'attendance' ? 'bg-slate-900 text-white shadow-lg shadow-slate-200' : 'bg-slate-100 text-slate-500 hover:bg-slate-200'}`}>
                                <span className="flex items-center gap-1.5"><Icon name="Clock" size={13} /> Attendance</span>
                            </button>
                            <button onClick={() => setProfileTab('payslips')} className={`px-4 py-2 rounded-xl text-xs font-bold transition-all ${profileTab === 'payslips' ? 'bg-slate-900 text-white shadow-lg shadow-slate-200' : 'bg-slate-100 text-slate-500 hover:bg-slate-200'}`}>
                            ...
                            <div className="p-8">
                                {attendanceRecords.length === 0 ? (
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-[10px] text-slate-300 mt-1">Attendance data will appear here once the employee checks in.</p>
                                    </div>
                                ) : (
                                        ...
                                        <table className="w-full">
                                            <thead>
                                                <tr className="border-b border-slate-100">
                                                    <th className="text-left text-[10px] font-bold text-slate-400 uppercase tracking-widest pb-3 pr-4">Date</th>
                                                    <th className="text-left text-[10px] font-bold text-slate-400 uppercase tracking-widest pb-3 pr-4">Check-in</th>
                                                    <th className="text-left text-[10px] font-bold text-slate-400 uppercase tracking-widest pb-3 pr-4">Check-out</th>
                                                    <th className="text-left text-[10px] font-bold text-slate-400 uppercase tracking-widest pb-3 pr-4">Hours</th>
                                                    <th className="text-left text-[10px] font-bold text-slate-400 uppercase tracking-widest pb-3">Status</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                            ...
                            <div className="p-8">
                                {payslipRecords.length === 0 ? (
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-[10px] text-slate-300 mt-1">Payslip records will appear here after payroll is processed.</p>
                                    </div>
                                ) : (
