  ...
  return (
    <div className="fixed bottom-6 left-6 z-50">
      <div className="relative">
        <button
          className="bg-primary text-primary-foreground p-3 rounded-full shadow-sm hover:bg-primary/90 transition"
          onClick={() => {
        ...
        <div
          ...
          className="hidden absolute bottom-14 left-0 w-80 bg-card border border-border rounded-lg shadow-sm overflow-hidden"
        >
 ...
 !notification.read ? 'bg-accent/30' : ''
                ...
                >
                  <div className="flex gap-2">
                    <div className={`mt-1 ${
 notification.type === 'TASK_ASSIGNED' ? 'text-primary' :
